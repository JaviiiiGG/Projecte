...
- Add Clojure, Common Lisp, Emacs Lisp, Scheme, and J (#246, [#240](https://github.com/stkb/Rewrap/issues/240))
...
- Python & Julia: all triple-quote strings should now work (however rST
  support is not there yet) (#157, [#203](https://github.com/stkb/Rewrap/issues/203)).
- Support Octave (#206).
...
- Also added native support for support for:
  - Verilog/SystemVerilog (#164, [#173](https://github.com/stkb/Rewrap/issues/173))
  - Prolog (#105, [#104](https://github.com/stkb/Rewrap/issues/104))
  - Bikeshed (#95)
  - Scala (#172, [#175](https://github.com/stkb/Rewrap/issues/175))
- Python: Fix some issues for triple-quoted strings, including allowing
  pre-string characters [bfru] (#171, [#170](https://github.com/stkb/Rewrap/issues/170), [#128](https://github.com/stkb/Rewrap/issues/128)).
...
- LaTeX: Preserve verbatim and math sections (#68, [#69](https://github.com/stkb/Rewrap/issues/69))
...
- Crystal and MATLAB languages added. (#71, [#72](https://github.com/stkb/Rewrap/issues/72))
...
- Fixed: With reformat setting on, code blocks in comments and markdown documents now have
  indents corrected.
- Code in a source file is no longer wrappable (#41, [#51](https://github.com/stkb/Rewrap/issues/51))
...
- Fixed an error caused by empty comments (#11, [#14](https://github.com/stkb/Rewrap/issues/14))

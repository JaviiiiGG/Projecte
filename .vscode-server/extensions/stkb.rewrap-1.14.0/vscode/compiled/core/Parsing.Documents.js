...
const languages = (0, _Util.createAtom)((0, _List.ofArray)([lang("AsciiDoc", "", ".adoc|.asciidoc", (0, _Util.uncurry)(2, plainText)), lang("AutoHotkey", "ahk", ".ahk", (0, _Util.uncurry)(2, (() => {
...
})())), lang("Clojure", "", ".clj|.cljs|.cljc|.cljx|.edn", (0, _Util.uncurry)(2, (() => {
  const commentParsers$$6 = new _Types.List((0, _Parsing2.line)(";+"), new _Types.List());
  ...
  const commentParsers$$7 = (0, _List.ofArray)([(0, _Parsing2.customBlock)((0, _Util.uncurry)(2, _Parsing4.javadoc))(["*#", " * "])(["###\\*", "###"]), (0, _Parsing2.block)(["###", "###"]), (0, _Parsing2.line)("#")]);
  return function (settings$$10) {
    return (0, _Parsing2.sourceCode)(commentParsers$$7, settings$$10);
  };
})())), lang("Common Lisp", "commonlisp|lisp", ".lisp", (0, _Util.uncurry)(2, (() => {
  const commentParsers$$8 = (0, _List.ofArray)([(0, _Parsing2.line)(";+"), (0, _Parsing2.block)(["#\\|", "\\|#"])]);
  ...
  const commentParsers$$9 = new _Types.List((0, _Parsing2.line)("#"), new _Types.List());
  ...
  const commentParsers$$10 = (0, _List.ofArray)([(0, _Parsing2.customLine)((0, _Util.uncurry)(2, _Parsing4.ddoc))("///"), _Parsing2.cLine, (0, _Parsing2.customBlock)((0, _Util.uncurry)(2, _Parsing4.ddoc))(["*", " * "])(_Parsing2.javadocMarkers), (0, _Parsing2.customBlock)((0, _Util.uncurry)(2, _Parsing4.ddoc))(["+", " + "])(["/\\+\\+", "\\+/"]), _Parsing2.cBlock, (0, _Parsing2.block)(["/\\+", "\\+/"])]);
  return function (settings$$13) {
    return (0, _Parsing2.sourceCode)(commentParsers$$10, settings$$13);
  };
})())), lang("Dart", "", ".dart", (0, _Util.uncurry)(2, (() => {
  const commentParsers$$11 = (0, _List.ofArray)([(0, _Parsing2.customLine)((0, _Util.uncurry)(2, _Parsing4.dartdoc))("///"), _Parsing2.cLine, (0, _Parsing2.customBlock)((0, _Util.uncurry)(2, _Parsing4.dartdoc))(["*", " * "])(_Parsing2.javadocMarkers), _Parsing2.cBlock]);
  ...
  const commentParsers$$12 = (0, _List.ofArray)([(0, _Parsing2.line)("#"), (0, _Parsing2.block)(["@(module|type|)doc\\s+\"\"\"", "\"\"\""])]);
  return function (settings$$15) {
    return (0, _Parsing2.sourceCode)(commentParsers$$12, settings$$15);
  };
})())), lang("Elm", "", ".elm", (0, _Util.uncurry)(2, (() => {
  const commentParsers$$13 = (0, _List.ofArray)([(0, _Parsing2.line)("--"), (0, _Parsing2.block)(["{-\\|?", "-}"])]);
  return function (settings$$16) {
    return (0, _Parsing2.sourceCode)(commentParsers$$13, settings$$16);
  };
})())), lang("Emacs Lisp", "elisp|emacslisp", ".el", (0, _Util.uncurry)(2, (() => {
  const commentParsers$$14 = new _Types.List((0, _Parsing2.line)(";+"), new _Types.List());
  return function (settings$$17) {
    return (0, _Parsing2.sourceCode)(commentParsers$$14, settings$$17);
  };
})())), lang("F#", "fsharp", ".fs|.fsx", (0, _Util.uncurry)(2, (() => {
  const commentParsers$$15 = (0, _List.ofArray)([(0, _Parsing2.customLine)((0, _Util.uncurry)(2, _Parsing4.xmldoc))("///"), _Parsing2.cLine, (0, _Parsing2.block)(["\\(\\*", "\\*\\)"])]);
  return function (settings$$18) {
    return (0, _Parsing2.sourceCode)(commentParsers$$15, settings$$18);
  };
})())), lang("Go", "", ".go", (0, _Util.uncurry)(2, (() => {
  const commentParsers$$16 = (0, _List.ofArray)([(0, _Parsing2.customBlock)((0, _Util.uncurry)(2, _Parsing4.godoc))(["", ""])(_Parsing2.javadocMarkers), _Parsing2.cBlock, (0, _Parsing2.customLine)((0, _Util.uncurry)(2, _Parsing4.godoc))("//"), _Parsing2.cLine]);
  return function (settings$$21) {
    return (0, _Parsing2.sourceCode)(commentParsers$$16, settings$$21);
  };
  ...
  const commentParsers$$17 = (0, _List.ofArray)([(0, _Parsing2.block)(["{{!--", "--}}"]), (0, _Parsing2.block)(["{{!", "}}"]), (0, _Parsing2.block)(["<!--", "-->"])]);
  return function (settings$$23) {
    return (0, _Parsing2.sourceCode)(commentParsers$$17, settings$$23);
  };
})())), lang("Haskell", "", ".hs", (0, _Util.uncurry)(2, (() => {
  const commentParsers$$18 = (0, _List.ofArray)([(0, _Parsing2.line)("--"), (0, _Parsing2.block)(["{-\\s*\\|?", "-}"])]);
  ...
  const commentParsers$$19 = (0, _List.ofArray)([(0, _Parsing2.customBlock)((0, _Util.uncurry)(2, _Parsing4.javadoc))(["*", " * "])(_Parsing2.javadocMarkers), _Parsing2.cBlock, (0, _Parsing2.customLine)((0, _Util.uncurry)(2, _Parsing4.javadoc))("//[/!]"), _Parsing2.cLine, (0, _Parsing2.line)("#")]);
  return function (settings$$25) {
    return (0, _Parsing2.sourceCode)(commentParsers$$19, settings$$25);
  };
})())), lang("HTML", "htmlx|vue", ".htm|.html|.vue", (0, _Util.uncurry)(2, _Parsing2.html)), lang("INI", "", ".ini", (0, _Util.uncurry)(2, (() => {
  const commentParsers$$20 = new _Types.List((0, _Parsing2.line)("[#;]"), new _Types.List());
  return function (settings$$26) {
    return (0, _Parsing2.sourceCode)(commentParsers$$20, settings$$26);
  };
})())), lang("J", "", ".ijs", (0, _Util.uncurry)(2, (() => {
  const commentParsers$$21 = new _Types.List((0, _Parsing2.line)("NB\\."), new _Types.List());
  return function (settings$$27) {
    return (0, _Parsing2.sourceCode)(commentParsers$$21, settings$$27);
  };
  ...
  const commentParsers$$22 = (0, _List.ofArray)([(0, _Parsing2.line)("#"), (0, _Parsing2.block)([".*?\"\"\"", "\"\"\""])]);
  return function (settings$$28) {
    return (0, _Parsing2.sourceCode)(commentParsers$$22, settings$$28);
  };
  ...
  const commentParsers$$23 = (0, _List.ofArray)([(0, _Parsing2.line)("--"), (0, _Parsing2.block)(["/-[-!]?", "-/"])]);
  return function (settings$$30) {
    return (0, _Parsing2.sourceCode)(commentParsers$$23, settings$$30);
  };
})())), lang("Less", "", ".less", (0, _Util.uncurry)(2, _Parsing2.java)), lang("Lua", "", ".lua", (0, _Util.uncurry)(2, (() => {
  const commentParsers$$24 = (0, _List.ofArray)([(0, _Parsing2.block)(["--\\[\\[", "\\]\\]"]), (0, _Parsing2.line)("--")]);
  return function (settings$$31) {
    return (0, _Parsing2.sourceCode)(commentParsers$$24, settings$$31);
  };
  ...
  const commentParsers$$25 = (0, _List.ofArray)([(0, _Parsing2.line)("%(?![%{}])"), (0, _Parsing2.block)(["%\\{", "%\\}"])]);
  ...
  const commentParsers$$26 = (0, _List.ofArray)([(0, _Parsing2.block)(["#\\{", "#\\}"]), (0, _Parsing2.block)(["%\\{", "%\\}"]), (0, _Parsing2.line)("##?"), (0, _Parsing2.line)("%[^!]")]);
  ...
  const commentParsers$$27 = (0, _List.ofArray)([(0, _Parsing2.customBlock)((0, _Util.uncurry)(2, _Parsing4.javadoc))(["*", " * "])(_Parsing2.javadocMarkers), _Parsing2.cBlock, (0, _Parsing2.line)("(?://|#)")]);
  ...
  const commentParsers$$28 = (0, _List.ofArray)([(0, _Parsing2.customLine)((0, _Util.uncurry)(2, _Parsing4.psdoc))("#"), (0, _Parsing2.customBlock)((0, _Util.uncurry)(2, _Parsing4.psdoc))(["", ""])(["<#", "#>"])]);
  return function (settings$$36) {
    return (0, _Parsing2.sourceCode)(commentParsers$$28, settings$$36);
  };
})())), lang("Prolog", "", "", (0, _Util.uncurry)(2, (() => {
  const commentParsers$$29 = (0, _List.ofArray)([(0, _Parsing2.customBlock)((0, _Util.uncurry)(2, _Parsing4.javadoc))(["*", " * "])(_Parsing2.javadocMarkers), _Parsing2.cBlock, (0, _Parsing2.line)("%[%!]?")]);
  ...
  const commentParsers$$30 = new _Types.List(_Parsing2.cLine, new _Types.List());
  ...
  const commentParsers$$31 = new _Types.List(_Parsing2.cLine, new _Types.List());
  return function (settings$$39) {
    return (0, _Parsing2.sourceCode)(commentParsers$$31, settings$$39);
  };
})())), lang("PureScript", "", ".purs", (0, _Util.uncurry)(2, (() => {
  const commentParsers$$32 = (0, _List.ofArray)([(0, _Parsing2.line)("--\\s*\\|"), (0, _Parsing2.line)("--"), (0, _Parsing2.block)(["{-\\s*\\|?", "-}"])]);
  return function (settings$$40) {
    return (0, _Parsing2.sourceCode)(commentParsers$$32, settings$$40);
  };
})())), lang("Python", "", ".py", (0, _Util.uncurry)(2, (() => {
  const commentParsers$$33 = (0, _List.ofArray)([(0, _Parsing2.line)("#"), (0, _Parsing2.block)([".*?\"\"\"", "\"\"\""]), (0, _Parsing2.block)([".*?'''", "'''"])]);
  return function (settings$$41) {
    return (0, _Parsing2.sourceCode)(commentParsers$$33, settings$$41);
  };
})())), lang("R", "", ".r", (0, _Util.uncurry)(2, (() => {
  const commentParsers$$34 = new _Types.List((0, _Parsing2.line)("#'?"), new _Types.List());
  return function (settings$$42) {
    return (0, _Parsing2.sourceCode)(commentParsers$$34, settings$$42);
  };
})())), lang("reStructuredText", "", ".rst|.rest", (0, _Util.uncurry)(2, plainText)), lang("Ruby", "", ".rb", (0, _Util.uncurry)(2, (() => {
  const commentParsers$$35 = (0, _List.ofArray)([(0, _Parsing2.line)("#"), (0, _Parsing2.block)(["=begin", "=end"])]);
  return function (settings$$44) {
    return (0, _Parsing2.sourceCode)(commentParsers$$35, settings$$44);
  };
})())), lang("Rust", "", ".rs", (0, _Util.uncurry)(2, (() => {
  const commentParsers$$36 = new _Types.List((0, _Parsing2.line)("\\/\\/(?:\\/|\\!)?"), new _Types.List());
  return function (settings$$45) {
    return (0, _Parsing2.sourceCode)(commentParsers$$36, settings$$45);
  };
})())), lang("SCSS", "", ".scss", (0, _Util.uncurry)(2, _Parsing2.java)), lang("Scala", "", ".scala", (0, _Util.uncurry)(2, _Parsing2.java)), lang("Scheme", "", ".scm|.ss|.sch|.rkt", (0, _Util.uncurry)(2, (() => {
  const commentParsers$$37 = (0, _List.ofArray)([(0, _Parsing2.line)(";+"), (0, _Parsing2.block)(["#\\|", "\\|#"])]);
  return function (settings$$46) {
    return (0, _Parsing2.sourceCode)(commentParsers$$37, settings$$46);
  };
})())), lang("Shaderlab", "", ".shader", (0, _Util.uncurry)(2, _Parsing2.java)), lang("Shell script", "shellscript", ".sh", (0, _Util.uncurry)(2, configFile)), lang("SQL", "postgres", ".pgsql|.psql|.sql", (0, _Util.uncurry)(2, (() => {
  const commentParsers$$38 = (0, _List.ofArray)([(0, _Parsing2.line)("--"), _Parsing2.cBlock]);
  return function (settings$$47) {
    return (0, _Parsing2.sourceCode)(commentParsers$$38, settings$$47);
  };
})())), lang("Swift", "", ".swift", (0, _Util.uncurry)(2, _Parsing2.java)), lang("Tcl", "", ".tcl", (0, _Util.uncurry)(2, configFile)), lang("TOML", "", ".toml", (0, _Util.uncurry)(2, configFile)), lang("TypeScript", "typescriptreact", ".ts|.tsx", (0, _Util.uncurry)(2, _Parsing2.java)), lang("Verilog/SystemVerilog", "systemverilog|verilog", ".sv|.svh|.v|.vh|.vl", (0, _Util.uncurry)(2, _Parsing2.java)), lang("XML", "xsl", ".xml|.xsl", (0, _Util.uncurry)(2, _Parsing2.html)), lang("YAML", "", ".yaml|.yml", (0, _Util.uncurry)(2, function (settings$$48) {
  const comments = (0, _Parsing2.line)("#{1,3}")(settings$$48);
  const partialParser$$1 = (0, _Parsing.takeUntil)(comments, plainText(settings$$48));
...
function addCustomLanguage(name$$1, markers) {
  ...
  const cl = lang(name$$1, "", "", (0, _Util.uncurry)(2, function (settings$$49) {
    return (0, _Parsing2.sourceCode)(list, settings$$49);
  }));
